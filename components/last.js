    ...
    <div className="text-dark">
      <Grid container>
        ...
        <Grid item container xs={2}>
          <ul className="bold text-white flex text-xl font-bold">Contact us</ul>
          <br />
          <br />
          <div className="flex">
            <div>
          ...
          <div className="flex ">
            ...
            <div className="text-white">ecell@iith.ac.in</div>
          </div>
          <div className="flex ">
            <div>
              <Image
            ...
            <div className="text-white">(+91)8979471587</div>
          </div>
        </Grid>
